...
def train(opt):
    ...
    for epoch in range(opt.epochs):
        ...
        for i, (batch_img1, batch_img2, batch_label1, _) in enumerate(train_tbar):
            ...
            loss = criterion(outs, (batch_label1, batch_label1))
            ...
            del batch_img1, batch_img2, batch_label1
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset-dir", type=str, default="/mnt/Disk1/liyemei/change_detection/Mei_CDNet/CDData/CL-CD/")
